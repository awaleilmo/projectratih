...
$kategori = $db_connect->query("SELECT * FROM jenis_produk WHERE id = '$id_kategori'")->fetch_assoc();
$list_produk = $db_connect->query("SELECT * FROM produk WHERE jenis_produk = '$id_kategori'");
$list_galery = $db_connect->query("SELECT * FROM galery WHERE jenis_produk = '$id_kategori'");
...
<body>
    ...
    <main id="main">
        ...
        <section id="portfolio" class="portfolio">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Galery</h2>
                    <h3>Check our <span><?= $kategori['jenis_produk'] ?></span> Galery</h3>
                    ...
                    <?php foreach ($list_galery as $galery) : ?>
                        <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $galery['jenis_produk'] ?>">
                            ...
                            <div class="portfolio-info">
                                ...
                                <a href="theme/BizLand/assets/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
        ...
        <section id="pricing" class="pricing">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Paket Layanan</h2>
                    <h3>Layanan <span><?= $kategori['jenis_produk'] ?></span></h3>
                    ...
                    <?php foreach ($list_produk as $produk) : ?>
                        ...
                        <div class="col" data-aos="fade-up" data-aos-delay="100">
                            <div class="box">
                                ...
                                <div class="btn-wrap">
                                    <a href="member/detail_produk?produk<?= $produk['id'] ?>" class="btn-buy">Detail</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
    ...
    <footer id="footer">
        ...
        <div class="container py-4">
            <div class="copyright">
                &copy; Copyright <strong><span>Nama Toko</span></strong>. All Rights Reserved
            </div>
            <div class="credits">

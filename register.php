                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="#" action="#" method="POST">
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Nama lengkap-->
                                <input type="text" placeholder="Nama Lengkap" name="nama" autocomplete="off" class="form-control bg-transparent" />
                                <!--end::Nama lengkap-->
                            </div>
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Alamat-->
                                <textarea placeholder="Alamat" name="alamat" autocomplete="off" class="form-control bg-transparent" /></textarea>
                                <!--end::Alamat-->
                            </div>
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <!--begin::Nomor Telpon-->
                                <input type="text" placeholder="Nomor Telepon" name="no_telpon" autocomplete="off" class="form-control bg-transparent" />
                                <!--end::Nomor Telpon-->
                            </div>
                            <!--begin::Input group=-->
                            <div class="fv-row mb-8">
                                <!--begin::Nomor Telpon-->
                                <input type="date" placeholder="Tanggal Lahir" name="tgl_lahir" autocomplete="off" class="form-control bg-transparent" />
                                <!--end::Nomor Telpon-->
                            </div>
                            <!--begin::Input group-->
                            <div class="row g-9 mb-8">
                                <select class="form-control bg-transparent" data-control="select2" data-hide-search="true" data-placeholder="Jenis Kelamin" name="jenis_kelamin" required>
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input placeholder="Repeat Password" name="repeat_password" type="password" autocomplete="off" class="form-control bg-transparent" />
                                <!--end::Repeat Password-->
                            </div>
                            <!--end::Input group=-->
                            <!--begin::Submit button-->

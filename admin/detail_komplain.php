                                            ...
                                            <div class="col-6">
                                                <div class="mb-5">
                                                    ...
                                                    <input type="text" name="nomor_invoice"
                                                           ...
                                                           value="<?= $list_komplain['nomor_invoice'] ?>" readonly/>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-5">
                                                    ...
                                                    <input type="text" name="status"
                                                           class="form-control form-control-solid" placeholder="Status"
                                                           value="<?= $list_komplain['status'] ?>" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-5">
                                            <label class="required form-label">User</label>
                                            <textarea name="user" class="form-control form-control-solid"
                                                      placeholder="user"
                                                      readonly/><?= $list_komplain['nama'] ?></textarea>
                                        </div>
                                        <div class="mb-5">
                                            <label class="required form-label">Nomor Telepon</label>
                                            <textarea name="user" class="form-control form-control-solid"
                                                      placeholder="user"
                                                      readonly/><?= $list_komplain['no_telpon'] ?></textarea>
                                        </div>
                                        <div class="mb-5">
                                            ...
                                            <textarea name="keterangan" class="form-control form-control-solid"
                                                      ...
                                                      rows="5"/><?= $list_komplain['keterangan'] ?></textarea>
                                        </div>
                                        <div class="mb-5">
                                            <label class="required form-label">Media</label>
                                            <input type="text" name="media" class="form-control form-control-solid"
                                                   placeholder="Media" value="<?= $list_komplain['media'] ?>" readonly/>
                                            <a href="../media_komplain/<?= $list_komplain['media'] ?>">Download
                                                media</a>
                                        </div>
                                        <div class="mb-5">
                                            <label class="required form-label">Dibuat pada</label>
                                            <input type="text" name="created_at" class="form-control form-control-solid"
                                                   placeholder="Created at" value="<?= $list_komplain['created_at'] ?>"
                                                   readonly/>
                                        </div>
                                        <div class="text-end">
                                            ...
                                            <button class="btn btn-danger <?= $list_komplain['status'] == 'selesai' || $list_komplain['status'] == 'ditolak' ? 'd-none' : '' ?>"
                                                    data-bs-toggle="modal" data-bs-target="#modal_tolak">Tolak
                                            </button>
                                            <a href="detail_komplain?id_komplain=<?= $_GET['id_komplain'] ?>&process=true"
                                               class="btn btn-info <?= $list_komplain['status'] != 'pending' ? 'd-none' : '' ?>"
                                               onclick="return confirm('Proses komplainan ini ?')">Proses</a>
                                            <a href="detail_komplain?id_komplain=<?= $_GET['id_komplain'] ?>&finish=true"
                                               class="btn btn-success <?= $list_komplain['status'] == 'pending' || $list_komplain['status'] == 'ditolak' ? 'd-none' : '' ?>"
                                               onclick="return confirm('Yakin untuk menyelesaikan komplainan ini ?')">Selesai</a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="timeline-content mb-10 mt-n1">
                                                                ...
                                                                <div class="pe-3 mb-5">
                                                                    ...
                                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                                        <!--begin::Info-->
                                                                        <div class="text-muted me-2 fs-7">Dibuat
                                                                            pada <?= $timeline['created_at'] ?>
                                                                            oleh <?= $nama_user ?></div>
                                                                        <!--end::Info-->
                                                                    </div>
                                                                    <!--end::Description-->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post">
                                <div class="mb-5">
                                    <input type="text" name="id_komplain" value="<?= $_GET['id_komplain'] ?>" hidden
                                           readonly>
                                    <input type="text" name="alasan_menolak" class="form-control form-control-solid"
                                           placeholder="Masukan alasan"/>
                                </div>
                                <div>
                                    <button type="submit" class="btn btn-primary" name="tolak_komplain"
                                            onclick="return confirm('data sudah benar ? ')">Submit
                                    </button>
                                </div>
                            </form>
                        </div>

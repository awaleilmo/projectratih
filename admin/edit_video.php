...
if (!isset($_GET['id'])) {
    header('Location: galeri_video');
}

if (isset($_POST['simpan'])) {
    if (ubah_galery($_POST)) {
        $id = $_POST['id'];
        echo "<script>alert('berhasil di rubah');location.href='galeri_video'</script>";
    }
}
...
<head>
    <base href="" />
    <title>Wld Project | Data video</title>
    <meta charset="utf-8" />
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit video</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                                                ...
                                                <div class="card card-flush py-4">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" name="judul" class="form-control mb-2" placeholder="Judul video" value="<?= $data_galeri['nama'] ?>" />
                                                            ...
                                                            <!--end::Input-->
                                                            <!--begin::Description-->
                                                            <div class="text-muted fs-7">Masukan judul video</div>
                                                            <!--end::Description-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            ...
                                                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                                <span class="required">Deskripsi video</span>
                                                            ...
                                                            <div class="text-muted fs-7">Deskripsi video</div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        ...
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            <div class="form-check form-switch">
                                                                ...
                                                                <label class="form-check-label" for="switchEditPhoto">Edit Video</label>
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div id="elementEditVideo" class="d-flex flex-column mb-8">
                                                            <label class="fs-6 fw-semibold mb-2">Files</label>
                                                            <input type="file" accept=".mp4" class="form-control form-control-solid" rows="3" name="media" placeholder="video">
                                                        </div>
                                                        <!--end::Input group-->
                                                    </div>
                                                    <!--end::Card header-->

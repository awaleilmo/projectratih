                            ...
                            <div class="row">
                                <?php foreach ($list_photo as $photo) : ?>
                                    <div class="col-md-3 mt-5">
                                        <div class="card">
                                            <img src="../image/galery/<?= $photo['media'] ?>" alt="photos" width="auto"
                                                 height="250px">
                                            <div class="card-body">
                                            ...
                                            <?php if ($_SESSION['role'] == 1) { ?>
                                                <div class="card-footer text-end">
                                                    ...
                                                    <a href="galeri_foto?hapus=<?= $photo['id'] ?>&jenis_media=<?= $photo['jenis_media'] ?>&media=<?= $photo['media'] ?>"
                                                       class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm"
                                                       onclick="return confirm('hapus media')">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" method="post" action=""
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid" placeholder="Judul" name="nama"
                                   required/>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <input type="file" class="form-control form-control-solid" rows="3" name="foto"
                                   placeholder="foto" required>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Actions-->
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary me-3" name="posting">Posting
                                <button>
                        </div>
                        <!--end::Actions-->
                    </form>

...
$list_video = $db_connect->query("SELECT * FROM galery WHERE jenis_media = 'video'");

if (isset($_POST['posting'])) {
    if (tambah_video($_POST)) {
        echo "<script>alert('berhasil di posting');location.href='galeri_video'</script>";
    } else {
...
if (isset($_GET['hapus'])) {
    ...
    if (hapus_galery($id, $jenis_media, $media)) {
        echo "<script>alert('berhasil di hapus');location.href='galeri_video'</script>";
    } else {
        // echo "<script>alert('Gagal');location.href='galeri_video'</script>";
    }
}
...
<head>
    <base href="" />
    <title>Wld Project | Galeri video</title>
    <meta charset="utf-8" />
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Galeri video</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Galeri video</li>
                                        <!--end::Item--><!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                        ...
                                        <div class="col-md-3 mt-5">
                                            <div class="card">
                                                <video controls class="img-fluid">
                                                    <source src="../videos/<?= $video['media'] ?>" type="video/mp4">
                                                </video>
                                                <div class="card-body">
                                                    <h5 class="card-title"><?= $video['nama'] ?></h5>
                                                    <p class="card-text"><?= $video['deskripsi'] ?></p>
                                                </div>
                                                <?php if($_SESSION['role'] == 1){ ?>
                                                <div class="card-footer text-end">
                                                    <a href="edit_video?id=<?= $video['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm" onclick="return confirm('edit data ?')">
                                                    ...
                                                    <a href="galeri_video?hapus=<?= $video['id'] ?>&jenis_media=<?= $video['jenis_media'] ?>&media=<?= $video['media'] ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm" onclick="return confirm('hapus media')">
                    ...
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                        ...
                        <form id="kt_modal_new_target_form" class="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-13 text-center">
                                ...
                                <!--end::Title-->
                                <!--begin::Description-->
                                <!-- <div class="text-muted fw-semibold fs-5">Isi kolom dengan benar
                                </div> -->
                                <!--end::Description-->
                            </div>
                            <!--end::Heading-->
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                    ...
                                    <span class="ms-1" data-bs-toggle="tooltip" title="Masukan deskripsi video">
                                        <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                                            <span class="path3"></span>
                            ...
                            <div class="d-flex flex-column mb-8">
                                ...
                                <input type="file" accept=".mp4" class="form-control form-control-solid" rows="3" name="video" placeholder="video" required>
                            </div>
                            <!--end::Input group-->
                            <!--begin::Actions-->

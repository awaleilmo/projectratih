...
$list_pelanggan = $_SESSION['role'] == 1 ? $db_connect->query("SELECT * FROM user WHERE is_admin = 0 ORDER BY nama") : $db_connect->query("SELECT * FROM user WHERE is_admin = 1 AND not role = 2 ORDER BY nama");

...
$list_komplain = $db_connect->query("SELECT komplain.*, user.nama FROM komplain JOIN user ON komplain.id_user = user.id");
?>
<!DOCTYPE html>
<!--
Author: Keenthemes
                                                ...
                                                <tbody>
                                                    <?php foreach ($list_komplain as $komplain) : ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="detail_komplain?id_komplain=<?= $komplain['id'] ?>" class="btn btn-sm btn-primary">Lihat</a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                                <!--end::Table body-->

...
if (isset($_POST['buat_paket'])) {
    ...
    if (tambah_produk($paket, $deskripsi, $jenis_produk, $harga, $foto, $video)) {
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Paket</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                                ...
                                <div class="card mb-5 mb-xl-8">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target"><i class="ki-duotone ki-plus fs-2"></i>Tambah Paket Baru</a>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <!--end::Header-->
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="detail_produk?produk=<?= $produk['id'] ?>" class="text-dark fw-bold text-hover-primary mb-1 fs-6"><?= $produk['nama'] ?></a>
                                                                        <a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
                                                                            <span class="text-dark">Rating</span>: <?= number_format($rating) ?></a>
                                                                    </div>
                                                                    <!--end::Name-->
                                                                </div>
                                                            </td>
                                                            <td class="fw-semibold text-end"><?= $jenis_produk ?></td>
                                                            <td class="fw-semibold text-end">Rp <?= number_format($produk['harga']) ?></td>
                                                            <?php if($_SESSION['role'] == 1){ ?>
                                                            <td class="text-end">
                                                                <a href="edit_paket?paket=<?= $produk['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm" onclick="return confirm('edit data ?')">
                                                                ...
                                                                <a href="data_paket?delete=<?= $produk['id'] ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm" onclick="return confirm('hapus data ?')">
                    ...
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                        ...
                        <form id="kt_modal_new_target_form" class="form" method="post" action="#" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="paket" name="paket" required />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="d-flex flex-column mb-8">
                                ...
                                <input class="form-control form-control-solid" rows="3" name="harga" placeholder="Harga" required>
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="file" accept="image/png, image/jpeg, image/jpg" class="form-control form-control-solid" placeholder="Harga" name="foto" value="" required />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary me-3" name="buat_paket">Buat Paket Baru</button>
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end:Form-->

...
if (isset($_POST['daftar'])) {
    ...
    if (tambah_user_administrator($nama, $username, $password, $email, $alamat, $jenis_kelamin, $tanggal_lahir, $no_telpon)) {
        echo "<script>alert('berhasil ditambah');location.href='administrator'</script>";
    }
}

$daftar_pelanggan = $db_connect->query("SELECT * FROM user WHERE is_admin != 0");
                                ...
                                <div class="card mb-5 mb-xl-8">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bold fs-3 mb-1">Data Administator</span>
                                        </h3>
                                        <div class="card-toolbar">
                                            <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target"><i class="ki-duotone ki-plus fs-2"></i>Tambah Administator</a>
                                        </div>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                                ...
                                                <tbody>
                                                    <?php foreach ($daftar_pelanggan as $pelanggan) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="fw-semibold text-end"><?= $pelanggan['jenis_kelamin'] ?></td>
                                                            <td class="fw-semibold text-end"><?= $pelanggan['tanggal_lahir'] ?></td>
                                                            <td class="fw-semibold text-end"><?= $pelanggan['alamat'] ?></td>
                                                            <td class="text-end"><?= $pelanggan['no_telpon'] ?></td>
                                                            <td class="text-end">
                    ...
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                        ...
                        <form id="kt_modal_new_target_form" class="form" method="post" action="#">
                            ...
                            <div class="mb-13 text-center">
                                <!--begin::Title-->
                                <h1 class="mb-3">Formulir Tambah Administator</h1>
                                <!--end::Title-->
                                <!--begin::Description-->

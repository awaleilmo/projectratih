...
if (isset($_POST['login'])) {
    ...
    $checking = $db_connect->query("SELECT * FROM user WHERE username = '$username' AND password = '$password' OR email = '$username' AND password = '$password'");

    if ($checking->num_rows > 0) {

        $data_user = $checking->fetch_assoc();
        $_SESSION['id_user'] = $data_user['id'];
        $_SESSION['url_photo'] = $data_user['photo'];
        $_SESSION['is_admin'] = $data_user['is_admin'] ? true : false;
...
<body id="kt_body" class="app-blank">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="#">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Silahkan login untuk melanjutkan</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group=-->
    ...
    <script src="theme/Metronic/assets/js/custom/authentication/sign-in/general.js"></script>

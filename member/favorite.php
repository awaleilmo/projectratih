...
$list_produk = $db_connect->query("SELECT f.*, p.*, jp.jenis_produk FROM favorit f JOIN produk p ON p.id = f.id_produk JOIN jenis_produk jp ON jp.id = p.jenis_produk WHERE f.id_user = '" . $_SESSION['id_user'] . "'");
// $list_produk = $db_connect->query("SELECT * FROM produk JOIN jenis_produk ON jenis_produk.id = produk.jenis_produk");
?>
<!DOCTYPE html>
<!--
Author: Keenthemes
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Favorit Saya</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                <div class="row">
                                            ...
                                            <div class="col-md-4 mt-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer">
                                                        ...
                                                        <a href="detail_produk?produk=<?= $produk['id'] ?>" class="btn btn-primary">Detail</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                                        <a href="index">
                                            <h1 class="text-center">Wishlist masih kosong nih, yuk pilih produk nya dulu</h1>
                                        </a>
                                    <?php endif; ?>
                                </div>
                            </div>

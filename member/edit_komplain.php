...
$data_komplain = $db_connect->query("SELECT * FROM komplain WHERE id = '" . $_GET['id'] . "'")->fetch_assoc();

if (isset($_POST['edit_komplain']) && $_GET['edit'] == 'keterangan') {
    $data = [
        'id_komplain'   => $_GET['id'],
        'keterangan'    => $_POST['keterangan']
    ];

    if (edit_keterangan_komplain($data)) {
        echo "<script>alert('berhasil');location.href='detail_komplain?komplain=" . $_GET['id'] . "'</script>";
    } else {
        echo "error";
    }
} else if (isset($_POST['edit_komplain']) && $_GET['edit'] == 'media') {
    $data = [
        'id_komplain'   => $_GET['id'],
        'media'         => $_FILES['media']
    ];

    if (edit_media_komplain($data)) {
        echo "<script>alert('berhasil');location.href='detail_komplain?komplain=" . $_GET['id'] . "'</script>";
    }
}
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Komplain</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">Edit Komplain</li>
                                        <!--end::Item-->
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                                ...
                                                <div class="card shadow-sm">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" name="nomor_invoice" class="form-control form-control-solid" placeholder="Nomor Invoice" value="<?= $data_komplain['nomor_invoice'] ?>" readonly />
                                                        </div>
                                                        <?php if ($_GET['edit'] == 'keterangan') : ?>
                                                            <div class="mb-5">
                                                                <label class="required form-label">Keterangan</label>
                                                                <textarea name="keterangan" class="form-control form-control-solid" placeholder="Keterangan" required rows="5" /><?= $data_komplain['keterangan'] ?></textarea>
                                                            </div>
                                                        <?php elseif ($_GET['edit'] == 'media') : ?>
                                                            <div class="mb-5">
                                                    ...
                                                    <div class="card-footer">
                                                        <button class="btn btn-primary btn-sm" name="edit_komplain">Submit Komplain</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>

                                        ...
                                        <div class="card shadow-sm mt-5">
                                            <div class="card-body">
                                                ...
                                                <?php if ($on_chart->num_rows > 0) : ?>
                                                    <a href="remove_chart?produk=<?= $produk['id'] ?>" class="btn btn-danger">Hapus dari Keranjang</a>
                                                <?php else : ?>
                                                    <a href="add_chart?produk=<?= $produk['id'] ?>" class="btn btn-primary">Masukan Keranjang</a>
                                                <?php endif; ?>
                                                &nbsp;&nbsp;
                                                <?php if ($is_favorite->num_rows > 0) : ?>
                                                    <a href="delete_favorit?produk=<?= $produk['id'] ?>"><i class="bi bi-heart-fill fs-4 text-danger"></i></a>
                                                <?php else : ?>
                                                    <a href="add_favorit?produk=<?= $produk['id'] ?>"><i class="bi bi-heart-fill fs-4"></i></a>
                                                <?php endif; ?>
                                            </div>

                                ...
                                <div class="">
                                    ...
                                    <div class="pb-12" id="print">
                                        ...
                                        <div class="d-flex flex-column gap-7 gap-md-10">
                                            ...
                                            <div class="fw-bold fs-2">Pesanan #<?= $data_pesanan['nomor_invoice'] ?>
                                                <a href="#" id="btnPrint"
                                                   class="btn float-end btn-sm fw-bold btn-primary"
                                                   onclick="printFunction()"><i class="ki-duotone ki-print fs-2"></i>Print</a>
                                            </div>
                                            <!--begin::Message-->
                                            <!--begin::Separator-->
                                                ...
                                                <div class="table-responsive border-bottom mb-9">
                                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <a href="#" class="symbol symbol-50px">
                                                                            <span class="symbol-label"
                                                                                  style="background-image:url(../image/galery/<?= $produk['photo'] ?>);"></span>
                                                                        </a>
                                                                        <!--end::Thumbnail-->
                                                                        <!--begin::Title-->
                                                                        <div class="ms-5">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                Rp <?= number_format($data_pesanan['total']) ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3" class="text-end">Sudah Dibayarkan</td>
                                                            <td class="text-end">
                                                                Rp <?= number_format(($data_pesanan['total'] - $data_pesanan['sisa'])) ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3" class="text-end">Sisa Tagihan</td>
                                                            <td class="text-end">
                                                                Rp <?= number_format($data_pesanan['sisa']) ?></td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="d-flex flex-stack flex-wrap mt-10 pt-13">
                                        ...
                                        <div class="my-1 me-5">
                                            ...
                                            <a href="add_komplain.php?pesanan=<?= $_GET['pesanan'] ?>"
                                               class="my-1 me-12">Komplain</a>
                                            <!-- end::Pint-->
                                            <!-- begin::Download-->
                                            ...
                                            <?php elseif ($status == 'Dibayar sebagian') : ?>
                                                <a href="#" class="btn btn-primary my-1" data-bs-toggle="modal"
                                                   data-bs-target="#kt_modal_new_target">Bayar sisa tagihan</a>
                                            <?php endif; ?>
                                            <!-- end::Action-->
                                        </div>
                                        <!-- end::Footer-->
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <?php foreach ($data_pembayaran as $payment) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../image/payment_proof/<?= $payment['bukti_pembayaran'] ?>"
                                ...
                                <div class="card-body">
                                    <div class="mb-5">
                                        ...
                                        <input type="hidden" name="nomor_invoice"
                                               value="<?= $data_pesanan['nomor_invoice'] ?>">
                                        <input type="number" name="nominal" class="form-control form-control-solid"
                                               value="<?= $data_pesanan['sisa']; ?>" max="<?= $data_pesanan['sisa']; ?>"
                                               required/>
                                    </div>
                                    <div class="mb-5">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="file" accept="image/jpg, image/jpeg, image/png"
                                               name="bukti_transfer" class="form-control form-control-solid"

                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                                            ...
                                                            <tfooter>
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <h3>Pembayaran dilakukan dengan transfer ke rekening BCA : 882982310, atas nama : Ucup Marucup</h3>
                                                                    </td>
                                                                </tr>
                                                            </tfooter>
                                                            <!--begin::Table footer-->
                                                ...
                                                <div class="card shadow-sm">
                                                    ...
                                                    <div class="card-body">
                                                        <?php foreach ($list_item_2 as $item) : ?>
                                                            ...
                                                            ?>
                                                            <div class="mb-5">
                                                                <label class="required form-label">Tanggal Booking Paket <?= $produk['nama'] ?></label>
                                                                <input type="date" name="tgl_booking_product[]" class="form-control form-control-solid date-input" placeholder="tanggal booking" required />
                                                                <input type="hidden" name="id_product[]" class="form-control form-control-solid" placeholder="ID Produk" value="<?= $produk['id'] ?>" required />
                                                                <input type="hidden" name="total_harga" class="form-control form-control-solid" placeholder="ID Produk" value="<?= $grand_total ?>" required />
                                                            </div>
                                                        <?php endforeach; ?>
                                                        <div class="mb-5">
                                                            <label class="required form-label">Nominal Pembayaran</label>
                                                            <input type="number" id="nominal" name="nominal" class="form-control form-control-solid" placeholder="Nominal" max="<?= $grand_total ?>" min="<?= ($grand_total * 0.5) ?>" required />
                                                        </div>
                                                        <div class="mb-5">
                                                        ...
                                                        <div class="mb-5">
                                                            ...
                                                            <textarea name="alamat" class="form-control form-control-solid" placeholder="Alamat" required /></textarea>
                                                        </div>
                                                    </div>
